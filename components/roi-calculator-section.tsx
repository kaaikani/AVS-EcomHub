...
export function ROICalculatorSection() {
  ...
  // Current metrics
  const currentCustomers = Math.round((inputs.monthlyVisitors * inputs.currentConversionRate) / 100)
  const currentRevenue = currentCustomers * inputs.averageOrderValue

  // Improved metrics with online platform
  const newConversionRate = inputs.currentConversionRate * (1 + improvements.conversion / 100)
  const newCustomers = Math.round((inputs.monthlyVisitors * newConversionRate) / 100)
  const newRevenue = newCustomers * inputs.averageOrderValue
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto text-balance">
            Calculate how much additional revenue your business could generate when you set up your online e-commerce platform
          </p>
        </div>
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          ...
                          {businessConfig.conversion}% increase in customer conversions within 30 days of launching online platform
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          <span className="font-medium text-white">Order processing:</span> Online platforms process orders{" "}
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5">
                      ...
                      <div>
                        <p className="text-sm text-gray-300">
                          ...
                          {businessConfig.satisfaction}% with 24/7 online shopping platform
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          >
            <Card className="p-6 md:p-8 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/15%),theme(backgroundColor.white/5%))] border-white/20 backdrop-blur-sm shadow-2xl h-full flex flex-col">
              <h3 className="text-xl md:text-2xl font-semibold text-white mb-6 md:mb-8">
                Your Sales Potential with AVS - ECOM HUB
              </h3>
              ...
              <div className="space-y-6 flex-1">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4">
                  <div className="text-center p-3 md:p-4 rounded-lg bg-gray-700/30">
                    ...
                    <div className="text-xl md:text-2xl font-bold text-white">{currentCustomers}</div>
                    <div className="text-xs text-gray-400">customers/month</div>
                  </div>
                  <div className="text-center p-3 md:p-4 rounded-lg bg-white/10 border border-white/20">
                    <div className="text-xs md:text-sm text-gray-300 mb-1">With our Platform</div>
                    <div className="text-xl md:text-2xl font-bold text-white">{newCustomers}</div>
                    <div className="text-xs text-gray-300">customers/month</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Additional Customers</span>
                    </div>
                    <span className="text-lg md:text-xl font-bold text-white">+{additionalCustomers}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 rounded-lg bg-white/5 border border-white/10">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm md:text-base text-white">Order Processing</span>
                    </div>
